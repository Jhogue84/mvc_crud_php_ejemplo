...
{
    private $routes2 = [
        //en este array poner url validas, y asignar una accion asi:
        //pero no valido,
        /*
        "contactos",
        "mision",
        "contactos2" => function () {
            echo ("Desde contactos 2"); //no correcto, la funcion callback
        },
        "mision2" => function () {
            echo ("Desde contactos 2");
        }
        */
        //recordar que las peticiones son GET POST asi
        'GET' => [],
        "POST" => []
    ];
    //mejorando codigo
